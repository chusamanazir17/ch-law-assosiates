    ...
    <div className="mb-4">
      ...
      <div className="bg-white dark:bg-[#0D1829] rounded-2xl border border-slate-200/90 dark:border-slate-800 p-4 sm:p-5 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xs relative overflow-hidden">
        ...
        <div className="flex items-center gap-3.5 z-10">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold font-admin text-slate-900 dark:text-slate-50 tracking-tight leading-tight">
              {title}
            </h1>
            <p className="text-xs sm:text-[13px] text-slate-500 dark:text-slate-400 font-normal mt-1 leading-relaxed">
              {subtitle}
            </p>
          </div>
        </div>
