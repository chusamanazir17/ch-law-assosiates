              ...
              {(isOfficeExpanded || isCollapsed) && (
                <div className={`mt-1 space-y-0.5 ${!isCollapsed ? 'pl-1' : ''}`}>
                  ...
                  >
                    ...
                    {!isCollapsed && <span>Fee Invoices</span>}
                  </button>
                  ...
                  {/* Chamber Staff Attendance */}
                  <button
                    onClick={() => handleNav('attendance')}
                    title="Chamber Staff Attendance"
                    className={`w-full flex items-center ${
                      isCollapsed ? 'justify-center py-2.5 px-0' : 'gap-2.5 px-3 py-2'
                    } rounded-lg text-left transition-colors cursor-pointer ${
                  ...
                  <div className="pt-2 mt-2 border-t border-slate-700/60">
                    <a
                      ...
                      className={`w-full flex items-center ${
                        isCollapsed ? 'justify-center py-2 px-0' : 'gap-2.5 px-3 py-2'
                      } rounded-lg text-amber-300 bg-amber-400/10 hover:bg-amber-400/20 font-semibold transition-colors`}
                    >
                      <Globe className="w-4 h-4 shrink-0 text-amber-400" />
                      {!isCollapsed && <span className="text-xs">Switch to Website CMS</span>}
                    </a>
                  </div>
                </div>
              )}
